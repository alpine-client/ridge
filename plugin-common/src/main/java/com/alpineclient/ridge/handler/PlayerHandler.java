 ...
 */
package com.alpineclient.ridge.handler;
...
import com.alpineclient.ridge.impl.objects.AlpinePlayerImpl;
...
public final class PlayerHandler {
    ...
    public boolean addConnectedPlayer(@NotNull Player player, @NotNull HandshakeData data) {
        ...
        if (!this.connectedPlayers.containsKey(id)) {
            AlpinePlayer alpinePlayer = new AlpinePlayerImpl(player, data);
